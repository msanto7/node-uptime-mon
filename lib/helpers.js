...
helpers.sendTwilioSms = function(phone, msg, callback) {
	...
	if(phone && msg) {
		...
		var req = https.request(requestDetails, function(res) {
			...
			//callback successfully if it went through
		...
		// bind to error event so an error isnt thrown
...
helpers.addUniversalTemplates = function(str, data, callbacl) {
		...
		if(!err && headerString) {
			...
			helpers.getTemplate('_footer', data, function(err, footerString) {
				if(!err && footerString) {
					...
					callack('Could not find the footer template');
				}
			}
		} else {
